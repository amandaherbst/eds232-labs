...
knn_rec <- recipe(Attrition ~ ., data = churn_train) %>% 
  # apply dummy coding to all nominal variables in dataset but not the outcomes
  step_dummy(all_nominal(), -all_outcomes(), one_hot = T) %>% 
  # normalize distance for KNN by centering and scaling
...
# model runs 60 times (5 folds times 6 possible k values)
