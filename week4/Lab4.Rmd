...
trees_test <- training(trees_split)
```
...
```
**Highest correlation with yr1status = DBH_cm, CVS_percent, BCHM_m. These will be the three predictors**
...
**all three are significant in the model.....**
...
```
**cv_model4 with all variables has the highest average accuracy of 90.3%** 
...
almost twice as much false positives than false negatives

> Question 13: What is the overall accuracy of the model? How is this calculated?

true positive rate? AUC?
